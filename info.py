...
BOT_TOKEN = environ['BOT_TOKEN', "7609890466:AAH7a92sI-6vJyfBccIQ7Om294X5ub8boJE"]
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002478597071').split()]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', "-1002414429311"))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', ''4)).split()]
